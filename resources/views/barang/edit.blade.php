                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('barang.update', $barang->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <img src="{{ asset('storage/files/images/' . $barang->image) }}" alt="photo of {{ $barang->image }}" class="img-thumbnail img-preview" width="100">
                            <input type="file" name="image" id="image" onchange="previewImage()" class="mt-1 block w-full file:py-1 file:px-2 file:rounded-full file:border-0 file:bg-blue-50 file:text-blue-700" accept="image/*">
